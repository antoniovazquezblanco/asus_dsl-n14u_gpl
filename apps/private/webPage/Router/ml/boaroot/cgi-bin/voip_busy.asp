...
<td class="tabdata"><font color="#000000"><img src=/exclamation.gif>&nbsp;<%tcWebApi_get("String_Entry","VoIPBusyMsgText","s")%></font>	
</td></tr><tr>
<td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata">&nbsp;</td><td class="tabdata">&nbsp;</td><td class="tabdata">
</td></tr><tr>
  ...
  <tr>
    <td width="160" class="black" height="42" >&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
	    <INPUT TYPE="BUTTON" NAME="SaveBtn" VALUE="<%tcWebApi_get("String_Entry","ButtonOKText","s")%>" onClick="window.history.back()">	</td></tr></table></div></form>
</body></html>
